...
- [C++: Техники за пределами прикладного минимума. Часть 1. Сильные типы](#c-техники-за-пределами-прикладного-минимума-часть-1-сильные-типы)
  ...
  - [Инструменты современного C++ (C++11...C++23)](#new-standards)
    - [Явная инициализация агрегатов (C++20)](#designated-initializers)
    - [Определяемые пользователем литералы (C++11)](#udl)
...
Последовательность техник в подборке такова, что сначала встречаются самые простые в освоении техники, и связанные с предыдущими. Оценка простоты конечно субъективна, но можно сказать, что требующая меньше кода техника — более проста, а синтаксис шаблонов, опирающийся на хорошо известный, нешаблонный синтаксис — проще, чем явное нововведение из новых элементов синтаксиса, поэтому, например, техники на основе концептов оцениваются как сложные.
...
Эту рутину можно частично упростить с помощью шаблонов (об этом в разделе «Инструменты оптимизации»), но для полной автоматизации правил поведения типов потребуются более специализированные инструменты. А пока рассмотрим еще одно преимущество разделения типов.
