...
- [C++: Техники за пределами прикладного минимума. Часть 1. Сильные типы](#c-техники-за-пределами-прикладного-минимума-часть-1-сильные-типы)
  ...
  - [Возможности и области применения](#возможности-и-области-применения)
    ...
    - [2. Возможность перегрузки функций](#2-возможность-перегрузки-функций)
    - [3. Гибкий порядок параметров](#3-гибкий-порядок-параметров)
  - [Не всё так просто: немного о практике](#не-всё-так-просто-немного-о-практике)
  ...
  - [Инструменты современного C++ (C++11...C++23)](#инструменты-современного-c-c11c23)
...
Как было показано ранее, главная проблема сильных типов — неизбежное дублирование инфраструктурного кода. Рациональный путь заключается в том, чтобы не отказываться от защиты, а делегировать генерацию однотипных операторов и конструкторов более мощным инструментам.
